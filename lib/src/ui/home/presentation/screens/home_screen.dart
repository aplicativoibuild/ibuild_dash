...
import '../../../../../shared/widgets/charts/card_chart.dart';
import '../../../../../shared/widgets/charts/filter_chart.dart';
import '../../../../../shared/widgets/charts/title_chart.dart';
    ...
    return SingleChildScrollView(
      child: Center(
        ...
        child: Column(
          ...
          children: [
            const WelcomeTitleWidget(pageName: 'Analytics'),
            Center(
              child: SizedBox(
                height: 600,
                child: Column(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: IgnorePointer(
                              child: CardChart(
                                  title: "Pedidos de orçamentos recebidos",
                                  value: "1093",
                                  colorText: Colors.black,
                                  colorBackgroud: Colors.white)),
                          onTap: () {
